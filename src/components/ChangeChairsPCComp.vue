<template>
  <div class="room">
    ...
    <div class="inputs">
      ...
      <button @click="addMember" class="add__member input">着席</button>
      <button @click="deleteMember" class="input">消す</button>
    </div>
    <div class="shuffle__wrapper">
      <button class="shuffle__btn input" @click="shuffleChairs(chairs)">席替え!!</button>
      <div class="gap__wrapper">
        <p class="gap">間隔</p>
        <div class="btn__wrapper">
          <button class="decrease" @click="decrease">狭く</button>
          <button class="increase" @click="increase">広く</button>
        </div>
      </div>
    </div>
